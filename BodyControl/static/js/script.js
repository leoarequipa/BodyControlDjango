...
function eliminar(usu) {
            ...
            alert("Se borro el usuario:"+usu);
      

}

function modificar(usu) {
...
function confirmarPago() {
    ...
    alert("Se pudo enviar su pago");
    alert("El sistema recibio su pago exitosamente");
 
}

function confirmarAlta(){
	alert("Se agrego el usuario al sistema");
}
...
function eliminarUsuario() {
    ...
    alert("Se borro el socio virtual");
...
function eliminarOperador(){
	   alert("Se borro el operador");
}
function eliminarEntidad(){
	 alert("Se borro la entidad");
}

function confirmarDatos(){
	alert("Se modificaron los datos personales");
}
function confirmarNuevoOperador(){
	alert("Se agrego un nuevo socio");
	
}
function AltaOperador(){
	alert("Se agrego un nuevo operador");
}

function altaOperadorCentral(){
	alert("Se agrego un operador central");
}
function confirmarAltaEntidad(){
	
	alert("Se agrego una nueva entidad");
}
function confirmarPago(){
	alert("Se confirmar el pago");
}
